...
const STEPS: TourStep[] = [
  {
    ...
    description: 'Vamos fazer um tour rápido para você conhecer tudo que o app oferece. Leva menos de 1 minuto!',
    tooltipSide: 'center',
  },
  {
    selector: '[data-tour="upload-zone"]',
    title: '📸 Analisar refeição',
    description: 'O coração do app. Fotografe qualquer refeição ou descreva em texto — a IA identifica os alimentos e calcula calorias, proteínas, carboidratos, fibras e gorduras em segundos.',
    tooltipSide: 'above',
    padding: 12,
  },
  {
    ...
    title: '📷 Câmera rápida',
    description: 'Acesso direto à câmera do celular. Fotografe sua refeição na hora sem precisar abrir a galeria.',
    tooltipSide: 'above',
    padding: 8,
  },
  {
    ...
    description: 'Você tem 7 dias grátis com análises ilimitadas. Após o teste, escolha o plano que melhor se encaixa na sua rotina.',
    tooltipSide: 'below',
    padding: 8,
  },
  {
    ...
    description: 'Acompanhe calorias, proteínas, carboidratos e gorduras em tempo real. Configure suas metas no perfil para ver o quanto falta para cada objetivo.',
    tooltipSide: 'above',
    padding: 10,
  },
  {
    ...
    description: 'Cardápio semanal personalizado, receitas com o que você tem em casa, chat com a nutricionista Evellyn e treino do dia — tudo gerado por IA para você.',
    tooltipSide: 'above',
    padding: 8,
  },
  {
    ...
    title: '💧 Hidratação',
    description: 'Registre a água do dia em ml usando containers pré-definidos (copo, caneca, garrafa…) ou valor customizado. A meta é calculada automaticamente pelo seu peso.',
    tooltipSide: 'above',
    padding: 8,
  },
  {
    ...
    description: 'Configure horários para cada refeição do dia e adicione lembretes personalizados — suplemento, água, treino — com emoji automático. Toque no header para expandir.',
    tooltipSide: 'above',
    padding: 8,
  },
  {
    ...
    title: '📊 Aba Progresso',
    description: 'Gráficos de calorias e nutrientes, histórico completo de refeições e relatório semanal com análise da Evellyn enviado por e-mail — exclusivo do plano Ilimitado.',
    tooltipSide: 'above',
    padding: 6,
  },
  {
    ...
    title: '👤 Aba Perfil',
    description: 'Atualize seus dados físicos, gerencie assinatura e cancele quando quiser. Configurar metas de calorias e proteína é essencial para o acompanhamento preciso.',
    tooltipSide: 'above',
    padding: 6,
  },
];
